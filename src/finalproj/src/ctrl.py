...
# #         self.max_steering_angle = 0.50  # max steering angle (in radians) add min
...
class PIDController:
    def __init__(self):
        ...
        self.max_steering_angle = 0.2  # max steering angle (in radians) add min
        ...
        self.correction_counter = 0 # counts 50 times for a sec when lane is not detected
